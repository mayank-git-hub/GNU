...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Connections
        ##################################################
        self.connect((self.blocks_add_xx_0_0, 0), (self.equalizer_dfe_dfe_0, 0))
        ...
        self.connect((self.equalizer_dfe_dfe_0, 0), (self.blocks_float_to_uchar_0, 0))
